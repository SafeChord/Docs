...
*   🧩 **SafeChord Ecosystem** - 系統全貌
    ...
    *   🟨 **Deployment Layer (Repo: SafeZone-Deploy)**
        ...
        *   [📄 safechord.safezone.deployment.md](safechord.safezone.deployment.md) ⭐ (Deployment Architecture & ADRs)
            *   [📄 safechord.safezone.deployment.workflow.md](safechord.safezone.deployment.workflow.md) (GitOps Workflow, ArgoCD, 環境晉��)
